...
export const metadata = {
  ...
  description: "Chartered accountants helping you keep more, grow faster, and worry less since 2012. Award-winning tax planning, business advisory, and compliance services in Harrow & Milton Keynes."
}
    ...
    <>
      <style dangerouslySetInnerHTML={{__html: `
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
        ...
        .svc-card-icon{width:50px;height:50px;border-radius:10px;background: