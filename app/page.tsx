          ...
          <div className="hero-grid">
            <div>
              ...
              <div className="hero-actions hero-fade d4">
                <a href="#contact" className="btn btn-gold">Book Free Consultation <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
        ...
        <div className="container">
          <div className="outcome-cards">
            <div className="outcome-card reveal">
              <div className="oc-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></div>
            ...
            <div className="outcome-card reveal" style={{transitionDelay:'.1s'}}>
              <div className="oc-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></div>
            ...
            <div className="outcome-card reveal" style={{transitionDelay:'.2s'}}>
              <div className="oc-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg></div>
          ...
          <div className="tool-panel" id="tool-compare">
            <div className="compare-grid">
              <div className="compare-col sole">
                ...
                <div className="compare-item pro"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 13l4 4L19 7"/></svg><span>Simple setup — register with HMRC for free</span></div>
                <div className="compare-item pro"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 13l4 4L19 7"/></svg><span>Less paperwork and reporting requirements</span></div>
                <div className="compare-item pro"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 13l4 4L19 7"/></svg><span>Keep all profits after tax</span></div>
                <div className="compare-item pro"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 13l4 4L19 7"/></svg><span>Full privacy — no public accounts filing</span></div>
                <div className="compare-item con"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 18L18 6M6 6l12 12"/></svg><span>Unlimited personal liability for debts</span></div>
                <div className="compare-item con"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 18L18 6M6 6l12 12"/></svg><span>Higher tax rates above £50,270 (40%)</span></div>
                <div className="compare-item con"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 18L18 6M6 6l12 12"/></svg><span>Less tax-efficient for higher earnings</span></div>
              </div>
              <div className="compare-col ltd">
                ...
                <div className="compare-item pro"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 13l4 4L19 7"/></svg><span>Limited liability — personal assets protected</span></div>
                <div className="compare-item pro"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 13l4 4L19 7"/></svg><span>Corporation Tax at 19-25% (lower than income tax)</span></div>
                <div className="compare-item pro"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 13l4 4L19 7"/></svg><span>Tax-efficient salary + dividend strategy</span></div>
                <div className="compare-item pro"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 13l4 4L19 7"/></svg><span>More credible to larger clients & contracts</span></div>
                <div className="compare-item con"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 18L18 6M6 6l12 12"/></svg><span>More admin — annual accounts & confirmation statement</span></div>
                <div className="compare-item con"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 18L18 6M6 6l12 12"/></svg><span>Public filing — accounts visible on Companies House</span></div>
                <div className="compare-item con"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 18L18 6M6 6l12 12"/></svg><span>Director responsibilities under company law</span></div>
              </div>
              <div className="compare-verdict">
                ...
                <a href="#contact" className="btn btn-gold" style={{marginTop:'8px'}}>Get Free Personalised Advice <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
              </div>
            </div>
          </div>
            ...
            <div className="advisory-text reveal-r">
              ...
              <div className="adv-cards">
                <div className="adv-card">
                  <div className="adv-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/></svg></div>
                ...
                <div className="adv-card">
                  <div className="adv-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M13 10V3L4 14h7v7l9-11h-7z"/></svg></div>
                  <div><h4>Cloud-First Technology</h4><p>Real-time dashboards via Xero, Dext & automated workflows. See your numbers anytime.</p></div>
                </div>
              </div>
              <a href="#contact" className="btn btn-navy">Let's Talk Strategy <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="portal-grid">
            <div className="portal-text reveal-l">
              ...
              <div className="portal-features">
                <div className="portal-feat"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Upload documents securely — no more email attachments</div>
                <div className="portal-feat"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Track your tax return status in real time</div>
                <div className="portal-feat"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>See all deadlines and never miss a filing date</div>
                <div className="portal-feat"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Message your accountant directly — responses within 4 hrs</div>
                <div className="portal-feat"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>E-sign documents without printing a single page</div>
              </div>
              <a href="#contact" className="btn btn-gold">Get Portal Access <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
            </div>
              ...
              <div className="portal-mock-items">
                <div className="portal-mock-item">
                  <div className="pmi-left">
                    <div className="pmi-icon doc"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg></div>
                ...
                <div className="portal-mock-item">
                  <div className="pmi-left">
                    <div className="pmi-icon tax"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg></div>
                ...
                <div className="portal-mock-item">
                  <div className="pmi-left">
                    <div className="pmi-icon pay"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1"/></svg></div>
                ...
                <div className="portal-mock-item">
                  <div className="pmi-left">
                    <div className="pmi-icon doc"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/></svg></div>
      ...
      <section className="testimonials">
        <div className="container">
          ...
          <div className="t3d-nav">
            <button className="t3d-btn" onclick="rotateCarousel(-1)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M15 19l-7-7 7-7"/></svg></button>
            ...
            <button className="t3d-btn" onclick="rotateCarousel(1)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 5l7 7-7 7"/></svg></button>
          </div>
        </div>
      </section>
            ...
            <div className="reveal-r">
              <div className="contact-form">
                ...
                <form onsubmit="event.preventDefault();alert('Thank you! We will contact you shortly.')">
                  ...
                  <div className="cf-submit"><button type="submit" className="btn btn-gold">Send Message <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M5 12h14M12 5l7 7-7 7"/></svg></button></div>
                </form>
              </div>
            </div>
          </div>
