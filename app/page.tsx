...
export const metadata = {
  ...
  description: 'Chartered Accountants in Harrow & Milton Keynes. We help you build a more profitable business, pay less tax, and get your weekends back.',
}
...
export default function HomePage() {
  return (
          ...
          <nav className="nav" id="navbar">
            <div className="container">
              <div className="nav-inner">
                ...
                <button className="mob-toggle" aria-label="Menu"><span></span><span></span><span></span></button>
              </div>
            </div>
          </nav>
              ...
              <div className="hero-grid">
                <div>
                  ...
                  <div className="hero-actions hero-fade d4">
                    <Link href="#contact" className="btn btn-gold">Book Free Consultation <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link>
                    <Link href="#tools" className="btn btn-outline-w">Try Free Tax Tools</Link>
                  </div>
                </div>
          ...
          <section className="tools" id="tools">
            <div className="container">
              ...
              <div className="tools-tabs reveal" style={{transitionDelay:'.2s'}}>
                <button className="tool-tab active">💰 Take-Home Pay</button>
                <button className="tool-tab">⚖️ Sole Trader vs Ltd</button>
                <button className="tool-tab">📋 VAT Checker</button>
                <button className="tool-tab">💼 Dividend vs Salary</button>
              </div>
              ...
              <div className="tool-panel active" id="tool-takehome">
                <div className="tool-layout">
                  <div className="tool-form">
                    ...
                    <button className="tf-btn">Calculate Take-Home Pay</button>
                  </div>
              ...
              <div className="tool-panel" id="tool-compare">
                <div className="compare-grid">
                  ...
                  <div className="compare-verdict">
                    ...
                    <Link href="#contact" className="btn btn-gold" style={{marginTop:'8px'}}>Get Free Personalised Advice <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="16" height="16"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link>
                  </div>
                </div>
              </div>
              ...
              <div className="tool-panel" id="tool-vat">
                <div className="tool-layout">
                  <div className="tool-form">
                    ...
                    <button className="tf-btn">Check VAT Status</button>
                  </div>
              ...
              <div className="tool-panel" id="tool-dividend">
                <div className="tool-layout">
                  <div className="tool-form">
                    ...
                    <button className="tf-btn">Optimise My Pay</button>
                  </div>
            ...
            <div className="container">
              <div className="advisory-grid">
                <div className="advisory-visual reveal-l">
                  <Image src="/images/advisory.jpg" alt="Advisory" className="advisory-img" width={600} height={400} />
                ...
                <div className="advisory-text reveal-r">
                  ...
                  <Link href="#contact" className="btn btn-navy">Let's Talk Strategy <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="16" height="16"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="container">
              <div className="portal-grid">
                <div className="portal-text reveal-l">
                  ...
                  <Link href="#contact" className="btn btn-gold">Get Portal Access <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="16" height="16"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link>
                </div>
    ...
    <section className="services" id="services">
      <div className="container">
        <div className="services-header">
          <div><div className="s-label reveal">What We Do</div><h2 className="s-title reveal">Expert Solutions for<br/><em>Every Financial Need</em></h2></div>
          <a href="https://mw.makesworth.uk/services/" className="btn btn-navy reveal">All Services <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="16" height="16"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
        </div>
    ...
    <section className="testimonials">
      <div className="container">
        <div className="test-header"><div className="s-label reveal">Client Stories</div><h2 className="s-title reveal">What Our Clients <em>Say</em></h2></div>
        <div className="t3d-scene reveal" id="t3dScene">
          <div className="t3d-carousel" id="t3dCarousel">
            <div className="t3d-card active" data-index="0">
              <div className="t3d-card-inner">
                ...
                <div className="t3d-author"><div className="t3d-avatar"><Image src="/rebecca-1.png" alt="Rebecca M" /></div><div><div className="t3d-name">Rebecca M</div><span className="t3d-role">Client</span></div></div>
              </div>
            </div>
            <div className="t3d-card" data-index="1">
              <div className="t3d-card-inner">
                ...
                <div className="t3d-author"><div className="t3d-avatar"><Image src="/Roberto-Baptista.png" alt="Roberto" /></div><div><div className="t3d-name">Roberto Baptista</div><span className="t3d-role">Client</span></div></div>
              </div>
            </div>
            <div className="t3d-card" data-index="2">
              <div className="t3d-card-inner">
                ...
                <div className="t3d-author"><div className="t3d-avatar"><Image src="/mihaela-solga.png" alt="Mihaela" /></div><div><div className="t3d-name">Mihaela Solga</div><span className="t3d-role">Long-term Client</span></div></div>
              </div>
            </div>
            <div className="t3d-card" data-index="3">
              <div className="t3d-card-inner">
                ...
                <div className="t3d-author"><div className="t3d-avatar">D</div><div><div className="t3d-name">David K</div><span className="t3d-role">Ltd Company Director</span></div></div>
              </div>
            </div>
            <div className="t3d-card" data-index="4">
              <div className="t3d-card-inner">
                ...
                <div className="t3d-author"><div className="t3d-avatar">S</div><div><div className="t3d-name">Sarah T</div><span className="t3d-role">Freelancer</span></div></div>
              </div>
            </div>
          </div>
    ...
    <section className="awards-ticker">
      <div className="container">
        ...
        <h2 className="s-title reveal">Award-Winning <em>Accountants</em></h2>
      </div>
      <div className="awards-ticker-outer">
        <div className="awards-ticker-row scroll-left">
          <div className="awards-ticker-card"><div className="awards-ticker-icon">🏆</div><div className="awards-ticker-divider"></div><div><div className="awards-ticker-title">Fast-track Firm of the Year 2021</div><div className="awards-ticker-sub">Accounting Excellence</div></div><div className="awards-ticker-badge">WINNER</div></div>
          <div className="awards-ticker-card"><div className="awards-ticker-icon">⭐</div><div className="awards-ticker-divider"></div><div><div className="awards-ticker-title">Client Service Award (Small Firms) 2023</div><div className="awards-ticker-sub">Accounting Excellence</div></div><div className="awards-ticker-badge">WINNER</div></div>
          <div className="awards-ticker-card"><div className="awards-ticker-icon">🏆</div><div className="awards-ticker-divider"></div><div><div className="awards-ticker-title">FSB Celebrating Small Business Awards</div><div className="awards-ticker-sub">Community Award — London</div></div><div className="awards-ticker-badge">FINALIST</div></div>
          <div className="awards-ticker-card"><div className="awards-ticker-icon">🏆</div><div className="awards-ticker-divider"></div><div><div className="awards-ticker-title">Award Winner 2024</div><div className="awards-ticker-sub">FSB Celebrating Small Business</div></div><div className="awards-ticker-badge">WINNER</div></div>
          <div className="awards-ticker-card"><div className="awards-ticker-icon">🏆</div><div className="awards-ticker-divider"></div><div><div className="awards-ticker-title">Community Impact Winner</div><div className="awards-ticker-sub">Small Business Awards</div></div><div className="awards-ticker-badge">WINNER</div></div>
          <div className="awards-ticker-card"><div className="awards-ticker-icon">🏆</div><div className="awards-ticker-divider"></div><div><div className="awards-ticker-title">For Our Planet — Gold Award 2024</div><div className="awards-ticker-sub">Ecologi Sustainability</div></div><div className="awards-ticker-badge">GOLD</div></div>
          <div className="awards-ticker-card"><div className="awards-ticker-icon">🏆</div><div className="awards-ticker-divider"></div><div><div className="awards-ticker-title">Top Small Accounting Firm</div><div className="awards-ticker-sub">Recognised Year on Year</div></div><div className="awards-ticker-badge">TOP</div></div>
          <div className="awards-ticker-card"><div className="awards-ticker-icon">🤝</div><div className="awards-ticker-divider"></div><div><div className="awards-ticker-title">98% Client Satisfaction Rate</div><div className="awards-ticker-sub">Verified Client Reviews</div></div><div className="awards-ticker-badge">VERIFIED</div></div>
          <div className="awards-ticker-card"><div className="awards-ticker-icon">🏆</div><div className="awards-ticker-divider"></div><div><div className="awards-ticker-title">Fast-track Firm of the Year 2021</div><div className="awards-ticker-sub">Accounting Excellence</div></div><div className="awards-ticker-badge">WINNER</div></div>
          <div className="awards-ticker-card"><div className="awards-ticker-icon">⭐</div><div className="awards-ticker-divider"></div><div><div className="awards-ticker-title">Client Service Award (Small Firms) 2023</div><div className="awards-ticker-sub">Accounting Excellence</div></div><div className="awards-ticker-badge">WINNER</div></div>
          <div className="awards-ticker-card"><div className="awards-ticker-icon">🏆</div><div className="awards-ticker-divider"></div><div><div className="awards-ticker-title">FSB Celebrating Small Business Awards</div><div className="awards-ticker-sub">Community Award — London</div></div><div className="awards-ticker-badge">FINALIST</div></div>
          <div className="awards-ticker-card"><div className="awards-ticker-icon">🏆</div><div className="awards-ticker-divider"></div><div><div className="awards-ticker-title">Award Winner 2024</div><div className="awards-ticker-sub">FSB Celebrating Small Business</div></div><div className="awards-ticker-badge">WINNER</div></div>
      ...
      <div className="awards-ticker-outer">
        <div className="awards-img-row scroll-left">
          <Image src="/awards.jpg" alt="Makesworth Awards — Community Impact, FSB 2024, Accounting Excellence 2021, Client Service 2023" className="awards-img" />
          <Image src="/awards_2.jpg" alt="Makesworth Awards — Accounting Excellence, FSB, Ecologi Gold 2024, Community Impact" className="awards-img" />
          <Image src="/awards.jpg" alt="Makesworth Awards" className="awards-img" />
          <Image src="/awards_2.jpg" alt="Makesworth Awards" className="awards-img" />
          <Image src="/awards.jpg" alt="Makesworth Awards" className="awards-img" />
          <Image src="/awards_2.jpg" alt="Makesworth Awards" className="awards-img" />
        </div>
      </div>
    ...
    <section className="team" id="team">
      <div className="container">
        <div className="team-header"><div className="s-label reveal">Our Team</div><h2 className="s-title reveal">Meet the <em>Experts</em></h2></div>
        <div className="team-grid">
          <div className="tm-card reveal"><div className="tm-img"><Image src="/sanjay_sah.jpg" alt="Sanjay Sah" /></div><h3>Sanjay Sah</h3><span className="role">Managing Director</span></div>
          <div className="tm-card reveal"><div className="tm-img"><Image src="/rakesh_gurung.jpg" alt="Rakesh Gurung" /></div><h3>Rakesh Gurung</h3><span className="role">Practice/Business Development Manager</span></div>
          <div className="tm-card reveal"><div className="tm-img"><Image src="/rajesh_sah.jpg" alt="Rajesh Sah" /></div><h3>Rajesh Sah</h3><span className="role">Branch Operations Manager</span></div>
          <div className="tm-card reveal"><div className="tm-img"><Image src="/indra_giri.jpg" alt="Indra Giri" /></div><h3>Indra Giri</h3><span className="role">Senior Consultant</span></div>
        </div>
      </div>
    </section>
      ...
      <div className="container">
        <div className="contact-grid">
          <div className="reveal-l">
            ...
            <p className="s-desc">Book your free consultation. We respond within 4 hours on business days.</p>
    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand"><Link href="#" className="nav-logo"><div className="icon">M</div><span>Makesworth</span></Link><p>Chartered accountants helping you keep more, grow faster, and worry less since 2012.</p><div className="footer-social"><a href="#">f</a><a href="#">𝕏</a><a href="#">ig</a><a href="#">in</a></div></div>
          <div className="footer-col"><h4>Company</h4><ul><li><Link href="#">About Us</Link></li><li><Link href="#">Our Team</Link></li><li><Link href="#">Case Studies</Link></li><li><Link href="#">Awards</Link></li><li><Link href="#">Careers</Link></li></ul></div>
          <div className="footer-col"><h4>Services</h4><ul><li><Link href="#">Accounting</Link></li><li><Link href="#">Tax & Compliance</Link></li><li><Link href="#">Business Advisory</Link></li><li><Link href="#">Tax Planning</Link></li><li><Link href="#">Audit & Assurance</Link></li></ul></div>
          <div className="footer-col"><h4>Contact</h4><ul><li><a href="tel:02079938850">020 7993 8850</a></li><li><a href="mailto:info@makesworth.co.uk">info@makesworth.co.uk</a></li><li><Link href="#">Harrow, HA1 1PD</Link></li><li><Link href="#">Milton Keynes, MK14 6LY</Link></li></ul></div>
        </div>
        <div className="footer-bottom"><p>© 2025 <Link href="#">Makesworth Accountants</Link>. All rights reserved.</p><p><Link href="#">Privacy</Link> · <Link href="#">Terms</Link> · <Link href="#">Cookies</Link></p></div>
      </div>
    </footer>
    ...
    <button className="chatbot-toggle" id="chatToggle" onClick="toggleChat()">
      ...
      <div className="toggle-calcy">
        ...
        <div className="t-sparkle">£</div>
        <div className="t-sparkle">%</div>
        <div className="t-sparkle">Σ</div>
    ...
    <div className="chatbot" id="chatbot">
          ...
          <div className="calc-body">
            <div className="calc-shell">
              ...
              <div className="calc-buttons" id="calcButtons">
                ...
                <div className="calc-btn num" data-val="0">0</div><div className="calc-btn num" data-val=".">.</div><div className="calc-btn equals" data-val="=">=</div>
              </div>
            </div>
            <div className="calc-eye el"><div className="eye-bg"><div className="eye-pupil"></div><div className="eye-lid"></div></div></div>
            <div className="calc-eye er"><div className="eye-bg"><div className="eye-pupil"></div><div className="eye-lid"></div></div></div>
      ...
      <div className="chatbot-input">
        <input type="text" id="chatInput" placeholder="Ask a UK tax question..." onKeyDown={(e) => e.key === 'Enter' && sendChat()} />
