...
<section className="services" id="services">
  <div className="container">
    <div className="services-header">
      ...
      <Link href="/services/" className="btn btn-navy reveal" style={{transitionDelay:'.2s'}}>All Services <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="16" height="16"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link>
    </div>
    <div className="services-grid">
      <div className="svc-card reveal"><div className="svc-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg></div><h3>Accounting & Bookkeeping</h3><p>Year-end accounts, cloud bookkeeping, and MTD-compliant digital records.</p><Link href="#" className="svc-link">Learn More <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="14" height="14"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link></div>
      <div className="svc-card reveal" style={{transitionDelay:'.1s'}}><div className="svc-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg></div><h3>Tax & Compliance</h3><p>VAT, payroll, pensions, R&D tax credits, and CIS rebates.</p><Link href="#" className="svc-link">Learn More <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="14" height="14"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link></div>
      <div className="svc-card reveal" style={{transitionDelay:'.2s'}}><div className="svc-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/></svg></div><h3>Business Advisory</h3><p>Cash flow forecasting, growth planning, and strategic financial guidance.</p><Link href="#" className="svc-link">Learn More <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="14" height="14"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link></div>
      <div className="svc-card reveal" style={{transitionDelay:'.3s'}}><div className="svc-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg></div><h3>Audit & Assurance</h3><p>Statutory, non-statutory, internal, and specialist audit services.</p><Link href="#" className="svc-link">Learn More <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="14" height="14"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link></div>
    </div>
  </div>
</section>
      ...
      <div className="t3d-carousel" id="t3dCarousel">
        <div className="t3d-card active" data-index="0">
          <div className="t3d-card-inner">
            ...
            <div className="t3d-author"><div className="t3d-avatar"><Image src="/wp-content/uploads/2025/01/rebecca-1.png" alt="Rebecca M" width={48} height={48} /></div><div><div className="t3d-name">Rebecca M</div><span className="t3d-role">Client</span></div></div>
          </div>
        </div>
        <div className="t3d-card" data-index="1">
          <div className="t3d-card-inner">
            ...
            <div className="t3d-author"><div className="t3d-avatar"><Image src="/wp-content/uploads/2025/01/Roberto-Baptista.png" alt="Roberto" width={48} height={48} /></div><div><div className="t3d-name">Roberto Baptista</div><span className="t3d-role">Client</span></div></div>
          </div>
        </div>
        <div className="t3d-card" data-index="2">
          <div className="t3d-card-inner">
            ...
            <div className="t3d-author"><div className="t3d-avatar"><Image src="/wp-content/uploads/2025/01/mihaela-solga.png" alt="Mihaela" width={48} height={48} /></div><div><div className="t3d-name">Mihaela Solga</div><span className="t3d-role">Long-term Client</span></div></div>
          </div>
        </div>
...
<section className="awards-ticker">
  ...
  <div className="awards-ticker-outer">
    <div className="awards-img-row scroll-left" style={{animationDirection:'reverse',animationDuration:'25s'}}>
      <Image src="/images/awards.jpg" alt="Makesworth Awards – Community Impact, FSB 2024, Accounting Excellence 2021, Client Service 2023" className="awards-img" width={300} height={200} />
      <Image src="/images/awards_2.jpg" alt="Makesworth Awards – Accounting Excellence, FSB, Ecologi Gold 2024, Community Impact" className="awards-img" width={300} height={200} />
      <Image src="/images/awards.jpg" alt="Makesworth Awards" className="awards-img" width={300} height={200} />
      <Image src="/images/awards_2.jpg" alt="Makesworth Awards" className="awards-img" width={300} height={200} />
      <Image src="/images/awards.jpg" alt="Makesworth Awards" className="awards-img" width={300} height={200} />
      <Image src="/images/awards_2.jpg" alt="Makesworth Awards" className="awards-img" width={300} height={200} />
    </div>
  </div>
...
<section className="team" id="team">
  <div className="container">
    ...
    <div className="team-grid">
      <div className="tm-card reveal"><div className="tm-img"><Image src="/images/sanjay_sah.jpg" alt="Sanjay Sah" width={300} height={300} /></div><h3>Sanjay Sah</h3><span className="role">Managing Director</span></div>
      <div className="tm-card reveal" style={{transitionDelay:'.1s'}}><div className="tm-img"><Image src="/images/rakesh_gurung.jpg" alt="Rakesh Gurung" width={300} height={300} /></div><h3>Rakesh Gurung</h3><span className="role">Practice/Business Development Manager</span></div>
      <div className="tm-card reveal" style={{transitionDelay:'.2s'}}><div className="tm-img"><Image src="/images/rajesh_sah.jpg" alt="Rajesh Sah" width={300} height={300} /></div><h3>Rajesh Sah</h3><span className="role">Branch Operations Manager</span></div>
      <div className="tm-card reveal" style={{transitionDelay:'.3s'}}><div className="tm-img"><Image src="/images/indra_giri.jpg" alt="Indra Giri" width={300} height={300} /></div><h3>Indra Giri</h3><span className="role">Senior Consultant</span></div>
    </div>
  </div>
</section>
...
<section className="blog">
  <div className="container">
    <div className="blog-header"><div><div className="s-label reveal">Insights</div><h2 className="s-title reveal" style={{transitionDelay:'.1s'}}>Latest <em>Articles</em></h2></div><Link href="/blog/" className="btn btn-navy reveal" style={{transitionDelay:'.15s'}}>All Articles <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="16" height="16"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link></div>
    <div className="blog-grid">
      <div className="bl-card reveal"><div className="bl-img"><Image src="/wp-content/uploads/2025/02/Understanding-the-VAT-Flat-Rate-Scheme-Is-It-Right-for-Your-Business.jpg" alt="" width={400} height={250} /></div><div className="bl-body"><div className="bl-meta"><span className="cat">Blog</span><span>Feb 2025</span></div><h3>Understanding the VAT Flat Rate Scheme: Is It Right for Your Business?</h3><Link href="#" className="bl-link">Read More <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="12" height="12"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link></div></div>
      <div className="bl-card reveal" style={{transitionDelay:'.1s'}}><div className="bl-img"><Image src="/wp-content/uploads/2025/01/Struggling-to-Pay-Your-Tax-Bill-Heres-What-You-Can-Do-1.jpg" alt="" width={400} height={250} /></div><div className="bl-body"><div className="bl-meta"><span className="cat">Blog</span><span>Jan 2025</span></div><h3>Struggling to Pay Your Tax Bill? Here's What You Can Do</h3><Link href="#" className="bl-link">Read More <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="12" height="12"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link></div></div>
      <div className="bl-card reveal" style={{transitionDelay:'.2s'}}><div className="bl-img"><Image src="/wp-content/uploads/2025/01/Simplifying-VAT-Compliance-Understanding-the-VAT-Flat-Rate-Scheme.jpg" alt="" width={400} height={250} /></div><div className="bl-body"><div className="bl-meta"><span className="cat">Blog</span><span>Jan 2025</span></div><h3>Simplifying VAT Compliance: Understanding the VAT Flat Rate Scheme</h3><Link href="#" className="bl-link">Read More <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="12" height="12"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link></div></div>
    </div>
  </div>
</section>
      ...
      <div className="reveal-r">
        <div className="contact-form">
          ...
          <form onSubmit={(e) => {e.preventDefault();alert('Thank you! We will contact you shortly.')}}>
            <div className="cf-row"><div className="cf-group"><label>Full Name</label><input type="text" placeholder="John Smith" required></input></div><div className="cf-group"><label>Phone</label><input type="tel" placeholder="+44 7XXX XXXXXX"></input></div></div>
            <div className="cf-row"><div className="cf-group"><label>Email</label><input type="email" placeholder="john@company.co.uk" required></input></div><div className="cf-group"><label>Business Name</label><input type="text" placeholder="Your Company Ltd"></input></div></div>
...
<footer className="footer">
  <div className="container">
    <div className="footer-grid">
      <div className="footer-brand"><a href="#" className="nav-logo"><div className="icon">M</div><span>Makesworth</span></a><p>Chartered accountants helping you keep more, grow faster, and worry less since 2012.</p><div className="footer-social"><a href="#">f</a><a href="#">𝕏</a><a href="#">ig</a><a href="#">in</a></div></div>
...
<div className="walking-calcy" id="walkingCalcy">
...
<button className="chatbot-toggle" id="chatToggle">
  ...
  <div className="chatbot-msgs" id="chatMsgs">
    <div className="chat-msg bot">
      ...
      <div className="chat-suggestions">
        <span className="chat-sug">📅 Self-assessment due?</span>
        <span className="chat-sug">🔷 Personal allowance?</span>
        <span className="chat-sug">⚖️ Sole trader vs Ltd?</span>
        <span className="chat-sug">📈 VAT registration?</span>
        <span className="chat-sug">💰 Tax rates?</span>
        <span className="chat-sug">🧾 Dividend allowance?</span>
        <span className="chat-sug">🏠 Work from home?</span>
        <span className="chat-sug">📱 Making Tax Digital?</span>
        <span className="chat-sug">👔 Employer NI?</span>
        <span className="chat-sug">🎓 Student loan?</span>
      </div>
    </div>
  </div>
  <div className="chatbot-input">
    <input type="text" id="chatInput" placeholder="Ask a UK tax question..."></input>
    <button><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/></svg></button>
  </div>
</div>
  )
}